       ...
       >
          {avatar ? (
           ...
           <div className="hidden sm:block text-left">
            ...
            className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors cursor-pinter"
            >
              View Profile
              </a>
              <div className="border-t border-gray-100 mt-2 pt-2">
                ...
                href="#"
                onClick={onLogout}
                className="block px-4 py-2 text-sm text-red-700 hover:bg-red-50 transition-colors cursor-pinter"
                >
                  Sign out
                </a>
                </div>
