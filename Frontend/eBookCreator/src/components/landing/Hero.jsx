...
const Hero = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-violet-50 via-white to-purple-50 overflow-hidden">
      <div className="absolute top-20 left-10 w-64 h-64 bg-violet-200/30 rounded-full blur-3xl animate-pluse"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-200/30 rounded-full blur-3xl animate-pluse delay-700"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-xl space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
              Create Stunning
              <span className="block mt-2 bg-gradient-to-br from-violet-600 via-purple-600 to-violet-600 bg-clip-text text-transparent">
                Ebooks in Minutes
              </span>
            </h1>
          ...
          <div className="relative lg:pl-8">
              ...
              <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div className="absolute top-6 right-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-right duration-700">
                  <div className="flex items-center space-x-3">
                    <div className="flex items-center w-10 h-10 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg justify-center">
                    ...
                    <div className="text-xs text-gray-500">
                      ...
                      <div className="">AI Generation</div>
                    </div>
                  </div>
                </div>
                <div className="absolute bottom-6 left-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-left duration-700 delay-300">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-xs text-gray-500">Complited</div>
                      <div className="text-sm font-semibold text-gray-900">
                        274 Pages
                      </div>
                    </div>
            ...
            <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-purple-400/20 rounded-full"></div>
          </div>
        </div>
      </div>
    </div>
