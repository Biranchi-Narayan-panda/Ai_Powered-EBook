...
const ChapterEditorTab = ({
  ...
  const [isFullSceen, setIsFullscreen] = useState(false);
  ...
  const formatMarkdown = (content) => {
    return content
      ...
      .replace(
        /^> (.*$)/gm,
        '<blockquote class="border-l-4 border-violet-500 pl-4 italic my-4 text-gray-700">$1</blockquote>',
      )
  ...
  return (
    <div
      className={`${isFullSceen ? "fixed inset-0 z-50 bg-white" : "flex-1"} flex flex-col`}
    >
      <div className="border-b border-gray-100 bg-white">
        <div className="px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-center gap md:gap-0 justify-between">
            <div>
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                onClick={() => setIsFullscreen(!isFullSceen)}
