...
const BookCard = ({ book, onDelete }) => {
  ...
  return (
      <div
      className="group relative bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-gray-200 transition-all duration-300 hover:shadow-xl hover:shadow-gray-200/50 hover:-translate-y-1 cursor-pointer"
...
<div className="absolute bottom-0 left-0 right-0 p-5 text-white">
  ...
  <div className="relative">
    <h3 className="font-semibold text-white text-sm leading-tight line-clam-2 mb-1">
      {book.title}
    </h3>
